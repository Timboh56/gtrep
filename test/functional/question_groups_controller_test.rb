...
class QuestionGroupsControllerTest < ActionController::TestCase
  ...
  test "should create question_group" do
    assert_difference('QuestionGroup.count') do
      post :create, question_group: { name: @question_group.name, question_groups_type: @question_group.question_groups_type, user_id: @question_group.user_id }
    end
  ...
  test "should update question_group" do
    put :update, id: @question_group, question_group: { name: @question_group.name, question_groups_type: @question_group.question_groups_type, user_id: @question_group.user_id }
    assert_redirected_to question_group_path(assigns(:question_group))
  end
